...
/// Hack to get around 'higher-ranked lifetime error', see
/// <https://github.com/rust-lang/rust/issues/100013>
pub struct StateCacheDbRefMutWrapper<'a>(pub &'a mut StateCacheDb);

impl core::fmt::Debug for StateCacheDbRefMutWrapper<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_struct("StateCacheDbRefMutWrapper").finish_non_exhaustive()
    }
}

impl revm::Database for StateCacheDbRefMutWrapper<'_> {
    type Error = <StateCacheDb as revm::Database>::Error;
...
impl revm::DatabaseRef for StateCacheDbRefMutWrapper<'_> {
    type Error = <StateCacheDb as revm::Database>::Error;
