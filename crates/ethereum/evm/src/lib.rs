...
#[derive(Debug)]
pub struct EthEvmConfig<C = ChainSpec, EvmFactory = MintEvmFactory> {
...
impl<ChainSpec> EthEvmConfig<ChainSpec> {
    ...
    /// Creates a new Ethereum EVM configuration with MintEvmFactory (default).
    pub fn ethereum(chain_spec: Arc<ChainSpec>) -> Self {
        Self::new_with_evm_factory(chain_spec, MintEvmFactory::default())
    }
}
