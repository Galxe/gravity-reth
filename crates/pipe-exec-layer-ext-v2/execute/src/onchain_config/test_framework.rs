...
impl OnchainConfigTestFramework {
    ...
    pub fn create_test_validator(
        ...
        ValidatorInfo {
            ...
            voteAddress: Bytes::from(format!("vote_addr_{}", validator_index).into_bytes()),
            ...
            createdTime: U256::from(1000 + validator_index),
            registered: true,
...
impl IntegrationTestResults {
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        let validator_set: Result<super::super::gravity_api_types::on_chain_config::validator_set::ValidatorSet, _> = 
    ...
    pub fn get_validator_set(&self) -> Result<super::super::gravity_api_types::on_chain_config::validator_set::ValidatorSet, bcs::Error> {
        bcs::from_bytes(&self.validator_set)
    }
}
